...
exports.kontribwixxi= function(req, res) {
    Kelma.findById(req.body.kelma, function (err, kelma){
        if (err || !kelma) {
            console.log('saving', req.body);
            new Kelma({_id: req.body.kelma, ezempju: req.body.ezempju}).save();
            res.send(200);
        } else {
            //jekk tezisti l-kelma diga, ma nistawx nhawdu l-edukazzjoni tal-poplu
            res.send(500);
        }
    });
};
